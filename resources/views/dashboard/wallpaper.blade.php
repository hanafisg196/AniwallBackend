                ...
                @foreach ($data as $item)
                    <div class="col-md-2">
                        <div class="card border-0 text-white">
                            <img class="card-img" src="{{ asset('storage/' . $item->thumbnail) }}" alt="wallpaper"
                                height="300">

                            <div class="card-img-overlay bg-overlay">
                                <div class="btn-group">
                                    <a type="button"
                                        class="btn btn-icon btn-warning waves-effect
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <form id="tagform" class="auth-login-form mt-2" method="post" enctype="multipart/form-data">
                    @csrf
                                ...
                                @foreach ($slide as $item)
                                    <label class="color-label">
                                        ...
                                        <span class="color-label-checkbox">
                                            <input type="checkbox" id="slide_id" name="slide_id"
                                                value="{{ $item->id }}">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            var textRemove = new Choices(
                document.getElementById('choices-text-remove-button'), {
                    ...
                    placeholderValue: 'Masukan Tag Baru',
                }
            );
        });
    </script>
