            ...
            <div class="dt-action-buttons text-end">
                <div class="dt-buttons d-inline-flex">
                    <button type="button" class="btn btn-gradient-primary pull-right" data-bs-toggle="modal"
                        ...
                        <span><i data-feather='plus'></i> Add Categories</span></button>
                </div>
            </div>
                ...
                @foreach ($data as $item)
                    <div class="col-md-3">
                        <div class="card border-0 text-white">
                            <img class="card-img" src="{{ asset('storage/' . $item->image . '?size=500') }}" alt="Card"
                                height="200">
                    ...
                    <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form class="auth-login-form mt-2" action="/categories/edit/{{ $item->id }}"
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="auth-login-form mt-2" action="/categories/insert" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-1">
                                    <label for="name">Name</label>
                                    <input class="form-control  @error('name') is-invalid @enderror"
                                        placeholder="Enter Categories Name" name="name" type="text"id="name"
                                        required>
