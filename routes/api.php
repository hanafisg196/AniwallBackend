...
Route::middleware(ApiAuthMiddleware::class)->group(callback: function () {
    ...
    Route::get('/wallpaper/slide/detail/{slideId}', [SlideApiController::class, 'slideDetail']);
    ...
    Route::post('/wallpaper/report/{wallpaperId}', [ReportApiController::class, 'sendReportWallpaper']);
    ...
    Route::middleware(AuthenticateUser::class)->group(callback: function () {
        Route::get('/wallpaper/user/profile/{userId}', [UserApiController::class, 'profile']);
